...
override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCellEditingStyle, forRowAt indexPath: IndexPath) {
 ...
 let shareAction = UITableViewRowAction(style: UITableViewRowActionStyle.default, title: "Share", handler: {(action,indexPath)-> Void in
         //   let defaultText = " Just Checking In At" + self.locations[indexPath.row].name!
 ...
 /*
    if let locationImage = self.locations[indexPath.row].image, let imageToShare = UIImage(data: locationImage as Data){
...
//        destinationController.location = (searchController.isActive) ?
//            searchResults[indexPath.row] : locations[indexPath.row]
//        destinationController.location = (searchController.isActive) ?
//            searchResults[indexPath.row] : locations[indexPath.row]
//        self.location = (searchController.isActive) ?
//            searchResults[indexPath.row] : locations[indexPath.row]
